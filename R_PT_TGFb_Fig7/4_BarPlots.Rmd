...
clustercolumn = "fibtype"
  ...
  r = table(sobject_sub[[clustercolumn]][,1],sobject_sub[[samplecolumn]][,1])
    ...
    name = paste0(project,"_", "_cluster-frequencies_of_total_noADWA11")
...
clustercolumn = "fibtype"
  ...
  r = table(sobject_sub[[clustercolumn]][,1],sobject_sub[[samplecolumn]][,1])
    ...
    name = paste0(project,"_", "_cluster-frequencies_of_total_nocKO")
...
clustercolumn = "immunetype"
  ...
  r = table(sobject_sub[[clustercolumn]][,1],sobject_sub[[samplecolumn]][,1])
    ...
    name = paste0(project,"_", "MYELOID_cluster-frequencies_of_total")
...
clustercolumn = "ttype"
  ...
  r = table(sobject_sub[[clustercolumn]][,1],sobject_sub[[samplecolumn]][,1])
    ...
    clusters_to_keep = c("T_CD4_Th1", "T_CD8", "T_Treg", "T_gdT", "T_Prolif", "T_NK", "T_ILC2", "T_T_other", "T_Dead_ribo")
    t = t[clusters_to_keep,]

    name = paste0(project,"_", "T_cluster-frequencies_of_total")
...
clustercolumn = "ttype"
  ...
  r = table(sobject_sub[[clustercolumn]][,1],sobject_sub[[samplecolumn]][,1])
    ...
    name = paste0(project,"_", "T_cluster-frequencies_of_total_noADWA11")
...
#measure Cd80 subclusters
```{r}
# Below uses total sobject WITH sub.cluster (see 3_Fibroblast_subset.Rmd - not saved into total sobject, modified before running this code)
# measure immune subsets across timepoints as % of a) total cells or b) lesion
sobject_sub = sobject
clustercolumn = "sub.cluster"
  ...
  r = table(sobject_sub[[clustercolumn]][,1],sobject_sub[[samplecolumn]][,1])
    ...
    clusters_to_keep = c("Sub_Altered-dural_immune_3", "Sub_Altered-dural_immune_0", "Sub_Altered-dural_immune_2", "Sub_Altered-dural_immune_1")
    t = t[clusters_to_keep,]

    name = paste0(project,"_", "Cd80_subcluster-frequencies_of_total")
