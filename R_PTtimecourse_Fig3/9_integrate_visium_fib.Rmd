...
predictions.assay <- TransferData(anchorset = anchors, refdata = sobject$fibtype, prediction.assay = TRUE, dims = c(1:30), weight.reduction = vobj.merge.sub10[["pca"]])
...
#test
SpatialFeaturePlot(vobj.merge.sub10, images = c(image1, image2, image3), features = "Fibroblast-Fn1")
```
