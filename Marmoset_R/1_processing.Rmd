...
```{r}
PrintSeuratGraph = function(namecard = "a",seurat_object = sobj,graphtype = "feature",feature = NULL,group = NULL,split=NULL,cellnames=NULL,order=NULL){
...
```{r}
#Specify your preferred directory for all input + output
dir= "/Users/nathanewing-crystal/Ari Molofsky Lab Dropbox/Ari Molofsky Lab Team Folder/Nathan Ewing-Crystal/RNASeq/Bourne Astrocytes/"

Plotfolder = "Plots/Myeloid"

setEPS()
postscript(file.path(dir, Plotfolder, "fab5_density.eps"), width = 12)
plot_density(sobj_sub18, c("TREM2", "CD9", "SPP1", "GPNMB", "CD63"), joint=T)
dev.off()

name = "figure"
PrintSeuratGraph(seurat_object = sobj_sub18, namecard = name,graphtype = "feature",feature = "TGFB1")
name = "figure_ordered"
PrintSeuratGraph(seurat_object = sobj_sub18, namecard = name,graphtype = "feature",feature = "TGFB1", order=T)
```
