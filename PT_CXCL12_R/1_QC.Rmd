...
dir= "/mnt/DATA/molofsky_lab/newing-crystal/Lesion_snRNASeq_3/seurat"
...
```{r}
samples = c("1_Ctrl", "2_cKO")
subsamples = c("Ctrl_lesion", "Ctrl_parenchyma", "cKO_lesion", "cKO_parenchyma")

#metadata to add
timepoint = c("21dpi", "21dpi")
genotype = c("WT", "cKO_Cxcl12")
microanatomy = c("Lesion", "Parenchyma","Lesion", "Parenchyma")
...
for(sample_iterate in 1:length(samples)){
  ...
  data.dir = file.path("/mnt/DATA/molofsky_lab/newing-crystal/Lesion_snRNASeq_3/cellranger_runs", sample, "outs/per_sample_outs", subsample, "/count/sample_filtered_feature_bc_matrix")
...
#Merge
```{r}
sobject.merge = merge(sobject_list[[1]], y=c(sobject_list[[2]], sobject_list[[3]], sobject_list[[4]]), add.cell.ids = subsamples)
```
